...
@available(iOS 13.0, *)
class WheelFortuneViewModel: ObservableObject {
    ...
    private var getWheelItemIndex: (() -> (Int))?
    private var onSpinStart: (() -> Void)?
    
    init(
        titles: [String], animDuration: Double, animation: Animation,
        onSpinEnd: ((Int) -> ())?, getWheelItemIndex: (() -> (Int))?, onSpinStart: (() -> Void)?
    ) {
        self.titles = titles
