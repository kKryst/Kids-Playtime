...
@available(iOS 14.0, *)
public struct WheelFortune: View {
    ...
    @StateObject var viewModel: WheelFortuneViewModel
    ...
    init(
        ...
        _viewModel = StateObject(wrappedValue: WheelFortuneViewModel(
            titles: titles,
    ...
    public var body: some View {
        ZStack(alignment: .top) {
            ZStack(alignment: .center) {
                WheelSpinView(data: (0..<titles.count).map { _ in Double(100/titles.count) },
